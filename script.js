...
function switchToStateFromURLHash() {
    ...
    switch (stateStr) {
        ...
        case 'Rules':
            pageHTML += "<div class='wrapper'><div class='box'><h3>Собирай монеты! Каждые 20 монет увеличивают скорость. Клавиша &#8593; прыжок вверх, &#8594; идешь направо, &#8592; налево.</h3></div><div class='box'><h3>Ускользай от полиции. Клавиша Ctrl-переход в состояние бомбы (убивает копов).Бомбой можно управлять. </h3></div><div class='box'><h3>У тебя 4 жизни. Если потратишь все-сядешь в тюрьму.</h3></div></div>";
...
function gameArea () {
    ...
    class Player {
        ...
        update(input, deltaTime, enemies) {
            ...
            if(!n) { //Если сталивается с полицейским вор
            ...
            if(n) { //Если сталивается с полицейским бомба
